...
namespace Project.BL
{
    public class MeetingBL : IMeetingBL
    {
        ...
        public bool InviteRecommend(MeetingDTO m)
        {
            ...
            var body = "<div style='background-color: bisque; margin: auto; padding: 25px; width: 90%; height: 100%;'>" +
        "   <div dir='rtl' style='background-color: white; margin: auto; width: 100%; height: 100%;'> " +
        "   <p bstyle='text-align: center;'>שלום ${meetingInfo.user[0].userName}</p><p style='text-align: center;'>נשמח אם תיכנס&nbsp; " +
        ...
        "   height: 30px; margin: 10px; display: inline-block;'><a style='color: black;' title='approve' href='http://localhost:4200/expert/" + m.idProf + "/add-recommend'>להכנס לטופס ההמלצה</a></p></div></div></div>";
        ...
        private static bool SendEmail(string to, string subject, string body)
        {
            ...
            mail.From = new MailAddress("nipageshbismachot2021@gmail.com");
            mail.To.Add(to);
